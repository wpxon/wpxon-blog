...
<div class="blog-detail-wrapper">
      <?php $wpxon_blog_gallery_items = get_post_meta( get_the_ID(), '_wpxon_blog_post_galery_list', 1 ); ?>
        <?php if(!empty($wpxon_blog_gallery_items)): ?>  
          <div class="image blog-details-img">
            <div id="blog-carousel" class="owl-carousel blog-carousel item1-carousel nf-carousel-theme">
              <?php foreach ( (array) $wpxon_blog_gallery_items as $attachment_id => $attachment_url ) { 
                $image_src = wp_get_attachment_image_src($attachment_id,'wpxon-blog'); 
